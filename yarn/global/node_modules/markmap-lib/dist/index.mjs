...
import { buildJSItem, buildCSSItem, Hook, wrapFunction, noop, UrlBuilder, persistCSS, persistJS } from 'markmap-common';
...
const plugin$1 = definePlugin({
  ...
  transform(transformHooks) {
    ...
    transformHooks.parser.tap(md => {
      ...
      md.renderer.rules.katex = wrapFunction(md.renderer.rules.katex, (render, ...args) => {
        enableFeature();
        return render(...args);
      });
    });
